...
[![Release](https://github.com/Safeguard-Inc/safeguard-policy/actions/workflows/release.yml/badge.svg)](https://github.com/Safeguard-Inc/safeguard-policy/actions/workflows/release.yml)
...
engine, and this layer's role in it. Built from the docs repository
([pipeline](https://github.com/Safeguard-Inc/safeguard-docs/tree/main/video)),
not edited by hand.
